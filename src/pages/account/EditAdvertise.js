...
import {readAdvertise, updateAdvertise} from '../../stores/action/advertiseAction';
import {readBooks} from '../../stores/action/bookAction';
import {useFormik} from 'formik';
import {editAdvertiseSchema} from '../../utils/validations';
...
const EditAdvertise = () => {
    ...
    const {data: advertise} = useSelector((state) => state.advertise.advertise);
    ...
    const formik = useFormik({
        ...
        initialValues: {
            image: undefined,
            book: advertise?.book?._id,
            isPublished: advertise?.isPublished ? advertise.isPublished : false
        },
        onSubmit: async (values) => {
            ...
            await dispatch(updateAdvertise(params.id, formData, navigate));
        },
        validationSchema: editAdvertiseSchema
    });
    ...
    return (
        <>
            ...
            <Helmet>
                ...
                <meta name="description" content="صفحه ویرایش تبلیغ"/>
            </Helmet>
                ...
                <AccountLayout>
                    ...
                    <div className="vstack gap-3">
                        ...
                        <div className="d-flex justify-content-between align-items-center w-100">
                            ...
                            <h1 className="fs-4 fw-bold text-primary">ویرایش تبلیغ</h1>
